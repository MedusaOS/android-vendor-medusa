...
ALARM_PATH := vendor/medusa/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/medusa/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/medusa/prebuilt/common/media/audio/ringtones
